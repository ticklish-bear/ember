...
// git-ignored and must be created locally (see PLAY_STORE_RELEASE.md). When the
// file is absent (CI, fresh clone, plain `flutter run`), the release build
// falls back to the debug keys so local builds keep working.
