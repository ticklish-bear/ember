...
- Basal body temperature readings and the time of measurement
- Cervical mucus observations
- Cervix self-check observations (if you enable that option)
- Menstrual bleeding
- Intercourse markers (if you enable that option)
- Free-text notes you add to a day
- Your app preferences (temperature unit, ruleset, reminder time, etc.)
...
- It does not read your contacts, location, photos, or other apps' data.
- It does not share data with any third party.

## Notifications

If you enable the optional daily check-in reminder, the notification is
scheduled and delivered entirely on your device by Android. No reminder data is
sent anywhere, and the notification contains only a generic prompt to chart.
...
You can delete individual entries, individual cycles, or all data at any time
from within the app (Settings → Delete all data). Uninstalling the app also
removes its local database from your device.
